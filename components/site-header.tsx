    ...
    <header className="sticky top-0 z-40 border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
      ...
      <div className="hidden border-b bg-gray-50 md:block">
        <div className="container mx-auto flex items-center justify-between px-4 py-2 text-sm text-gray-600">
          <p className="font-medium">Call: +919005172912, 9580753193  • Email: care@himanshuhospital.com</p>
      ...
      <div className="container mx-auto flex items-center justify-between px-4 py-3">
        <Link href="/" className="flex items-center gap-2">
          <div className="size-9 rounded bg-blue-600" aria-hidden />
          <span className="text-lg font-bold text-gray-900">Himanshu MultiSpecilist Hospital</span>
        </Link>
